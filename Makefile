...
.PRECIOUS: docker-compose.override.yml

install: ## Process all step in order to setup the projects
install: up vendor-install

update: ## Update the project
update: up vendor-install
...
ouragan: ## Execute ouragan command
	$(EXEC) $(CON) ouragan:abri:disponible
.PHONY: ouragan